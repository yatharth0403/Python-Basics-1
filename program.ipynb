...
#initialise the rows and columns.It is used to create the board of game
ROWS=3
COLUMNS=3
...
#to check whether a particular place is full or not.
def is_valid_mark(row,col):
	return board[row][col]==0  #return either true or false

#function to check whether the board is full or not to end the game.
def is_board_full():
...
#Make a matrix of 3X3 and initialise it with zeros with method.
